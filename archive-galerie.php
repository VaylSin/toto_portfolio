<?php
/**
 * The template for displaying archive pages for galerie post type
 *
	...
	<main id="primary" class="site-main">
		...
		<?php if ( have_posts() ) : ?>
			...
			<header class="page-header">
				<h1 class="page-title">
					<?php
					echo esc_html__( 'Galleries', 'toto-portfolio' );
					?>
				</h1>
				...
				if ( ! empty( $categories ) && ! is_wp_error( $categories ) ) :
					...
					<div class="galerie-category-filter">
						<a href="<?php echo esc_url( get_post_type_archive_link( 'gallerie' ) ); ?>" 
						   class="filter-link <?php echo ! is_tax( 'galerie-categorie' ) ? 'active' : ''; ?>">
			...
			<div class="no-galleries-found">
				<h2><?php esc_html_e( 'Aucune galerie trouvée', 'toto-portfolio' ); ?></h2>
				<p><?php esc_html_e( 'Il n\'y a actuellement aucune galerie à afficher.', 'toto-portfolio' ); ?></p>
			</div>
			<?php
		endif;
		?>
